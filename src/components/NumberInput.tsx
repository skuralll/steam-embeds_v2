    ...
    <div className="max-w-xs mx-auto">
      ...
      <div className="relative flex items-center max-w-[8rem] h-10">
        ...
        <input
          ...
          className="bg-gray-50 border border-x-0 border-gray-300 h-full text-center text-gray-900 text-sm focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent block w-full py-2.5"
